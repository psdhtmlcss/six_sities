...
import { AppDispatch, Offers, State, UserData, AuthData } from 'types';
import { loadOffers, requireAuthorization, setError, setLoadingDataStatus, redirectToRoute, setUserEmail } from './action';
